  ...
  return (
    <div className="px-10">
      ...
      <div>
        ...
        <p className="text-xl">
          Number of awards and recognitions received for extension activities
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
              ...
              <th scope="col" className="px-4 py-3">
                Name of the Awarding government bodies
              </th>
            </tr>
          </thead>
          <tbody>
          ...
          <div>
            <div className="grid grid-cols-3 gap-5">
              ...
              <div className="col-span-1">
                ...
                <input
                  type="text"
                  placeholder="Name of the Award/recognition"
                  className="w-full mt-2  border border-gray-200 rounded-md p-2"
                />
              </div>
            </div>
            <div className="grid grid-cols-1 gap-5 mt-7">
              <div className="col-span-1">
                ...
                <input
                  type="text"
                  placeholder=" Name of the Awarding government/ government recognized bodies"
                  className="w-full mt-2  border border-gray-200 rounded-md p-2"
                />
              </div>
            </div>
